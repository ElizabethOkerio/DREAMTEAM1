...
db = sqlite3.connect('skills.db')
skill_name = raw_input("Enter Skill: ")
skill_status = raw_input("Enter Status(Whether Studied or Not Studied): ")
cursor = db.cursor()
...
skill_name = raw_input("Press enter to view skills with their status: ")
...
skill_name = raw_input("Press enter to view if skills are studied or not studied: ")
